...
def create_fir_pdf(fir_data: dict) -> bytes:
    ...
    # Setup Doc — ReportLab uses points as default unit (1 pt = 1)
    ...
    header_table = Table([[header_left, header_center, header_right]], colWidths=[130, 220, 149])
    ...
    s2 = make_table([["2. OCCURRENCE OF OFFENCE:", s2_inner]], [120, 379])
    story.append(s2)

    # ─────────────────────────────────────────────────────
    # SECTIONS 3-8
    # ─────────────────────────────────────────────────────
    s3 = make_table([["3. INFORMATION RECEIVED AT P.S.:", f"Date: {date_str}   Time: {time_str}   Type: Written"]], [120, 379])
    story.append(s3)

    s4 = make_table([["4. GENERAL DIARY REFERENCE:", "Entry No. ______   Time: ______"]], [120, 379])
    story.append(s4)

    s5 = make_table([["5. TYPE OF INFORMATION:", Paragraph("<b>Written</b> / Oral", p_body)]], [120, 379])
    story.append(s5)
    ...
    s6 = make_table([["6. PLACE OF OCCURRENCE:", s6_inner]], [120, 379])
    story.append(s6)

    s7 = make_table([["7. OUTSIDE P.S. LIMITS (IF YES, NAME OF P.S.):", "Yes / No   |   If Yes: _______________"]], [120, 379])
    story.append(s7)

    s8 = make_table([["8. BEAT NO.:", ""]], [120, 379])
    story.append(s8)
    ...
    acc_sex = "Male" if comp_gender == "female" else "—"
    ...
    s9_inner = Table(s9_data, colWidths=[25, 70, 60, 25, 30, 50, 40, 69])
    ...
    s9 = make_table([["9. DETAILS OF KNOWN / SUSPECTED ACCUSED:", s9_inner]], [120, 379])
    story.append(s9)

    # ─────────────────────────────────────────────────────
    # SECTIONS 10-14
    # ─────────────────────────────────────────────────────
    s10 = make_table([["10. REASONS FOR DELAY IN REPORTING:", "None"]], [120, 379])
    story.append(s10)

    # Properties
    props = fir_data.get('properties', [])
    if not props:
        s11 = make_table([["11. PARTICULARS OF PROPERTIES STOLEN / INVOLVED:", "Not Applicable"]], [120, 379])
        s12 = make_table([["12. TOTAL VALUE OF PROPERTIES STOLEN:", "Not Ascertained"]], [120, 379])
    else:
        ...
        p_inner = Table(p_data, colWidths=[30, 180, 80, 79])
        ...
        s11 = make_table([["11. PARTICULARS OF PROPERTIES STOLEN / INVOLVED:", p_inner]], [120, 379])
        s12 = make_table([["12. TOTAL VALUE OF PROPERTIES STOLEN:", "₹ See above"]], [120, 379])

    story.append(s11)
    story.append(s12)

    s13 = make_table([["13. INQUEST REPORT / POST MORTEM EXAMINATION REPORT:", "Not Applicable"]], [120, 379])
    story.append(s13)

    s14 = make_table([["14. FIRST MEDICAL EXAMINATION OF THE INJURED:", "Not Applicable"]], [120, 379])
    story.append(s14)
    ...
    s15 = make_table([["15. COMPLAINANT / INFORMANT:", c_inner]], [120, 379])
    story.append(s15)
    ...
    s16 = make_table([["16. DETAILS OF ACTION TAKEN SINCE FIRST INFORMATION:", Paragraph(s16_text, p_body)]], [120, 379])
    story.append(s16)
    ...
    s17_table = Table([[s17_left, s17_right]], colWidths=[250, 249])
    ...
    # Simple markdown-to-html cleanup
    ...
    narr_table = Table([[narrative_title, ""], [narrative_body, ""]], colWidths=[499, 0])
